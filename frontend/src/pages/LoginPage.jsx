...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // --- SIMULATING API CALL ---
    setTimeout(() => {
      if (formData.email === "student@demo.com" && formData.password === "password") {
        setSuccess(true);
        // In a real app, you would redirect here (e.g., navigate('/dashboard'))
        console.log("Login Successful");
      } else {
        setError("Invalid email or password. (Try: student@demo.com / password)");
        setIsLoading(false);
      }
    }, 1500);
  };
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-indigo-200 text-sm">Full Stack Developer @ TechCo</p>
              </div>
            </div>
          </div>
        </div>
